...
import org.silva.settlement.infrastructure.rlp.RLPUtil;
import org.silva.settlement.core.chain.ledger.model.BaseTransaction;
...
public class EthTransaction extends BaseTransaction {
    ...
    public void setErrEthTransactionReceipt(String err) {
        this.ethTransactionReceipt = new EthTransactionReceipt(this, 0, EMPTY_BYTE_ARRAY, err);
    }
